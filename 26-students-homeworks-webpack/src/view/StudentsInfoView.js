import $ from 'jquery';
import studentItemTemplate from './StudentsInfoView.html';

export default class StudentsInfoView {
  ...
  generateStudentHtml(student) {
    ...
    return this.fillStudentItem(data, studentItemTemplate);
  }

  fillStudentItem(data, template) {
    let res = template;
